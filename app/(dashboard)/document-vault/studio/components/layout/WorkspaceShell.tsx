   ...
   return (
      <div className="h-screen bg-card text-white flex flex-col relative overflow-hidden">
         ...
         <main className="flex-1 flex overflow-hidden">
            ...
            <div className="flex-1 relative flex flex-col bg-card">
               <AnimatePresence mode="wait">
                  {activeDocument ? (
                     ...
                     >
                        {(activeDocument.link || activeDocument.webViewLink) && !isMock && (!['xlsx', 'xls', 'sheet'].includes(activeDocument.type) || (activeDocument.link?.includes('docs.google.com') || activeDocument.webViewLink?.includes('docs.google.com'))) ? (
            ...
            {!isFullScreen && activeDocument && (
               <RightSidebar documentTitle={activeDocument.title} documentId={activeDocument.id} />
            )}
         </main>
      </div>
   );
