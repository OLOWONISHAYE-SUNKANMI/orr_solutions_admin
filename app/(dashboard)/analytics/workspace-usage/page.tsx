    ...
    const fetchData = async () => {
      try {
        const [workspaceRes, adoptionRes] = await Promise.all([
          fetch(`${process.env.NEXT_PUBLIC_API_URL || 'http://127.0.0.1:8000'}/admin-portal/v1/workspace-usage/analytics/`),
          fetch(`${process.env.NEXT_PUBLIC_API_URL || 'http://127.0.0.1:8000'}/admin-portal/v1/workspace-usage/feature-adoption/`)
        ]);
