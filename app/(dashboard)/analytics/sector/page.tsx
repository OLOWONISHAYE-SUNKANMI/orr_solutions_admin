    ...
    const fetchData = async () => {
      try {
        const [sectorRes, benchmarkRes] = await Promise.all([
          fetch(`${process.env.NEXT_PUBLIC_API_URL || 'http://127.0.0.1:8000'}/admin-portal/v1/sector-insights/sector-analytics/`),
          fetch(`${process.env.NEXT_PUBLIC_API_URL || 'http://127.0.0.1:8000'}/admin-portal/v1/sector-insights/industry-benchmarks/`)
        ]);
